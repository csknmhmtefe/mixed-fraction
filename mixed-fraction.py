...
#for using:
variable = MixedFraction(10,2) #first parameter for dividend, second parameter for divisor
print(variable)

#You can also perform mathematical operations with multiple mixed numbers.
variable = MixedFraction(10,2)
variable2 = MixedFraction(20,3)
